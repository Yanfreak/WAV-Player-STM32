...
*******************************************************************************
  ...
  FileName		: PWR/STOP/main.c 
  Author		: lichy       
  Version 		: 1.0.0     
  Date			: 2011/09/30
  Description	: Enter Stop Mode£¬user1 button (EXTI_Line15) will be used 
  				  to wakeup ths system from STOP mode 
  Function List : 
  History		:
  <author>  	: lichy       
  <time>     	: 2011/10/09
...
int main(void)
{
  ...
  /* Initialize LEDs and user1 Button mounted on DevKit1207 board */
  STM_EVAL_LEDInit(LED2);
  STM_EVAL_LEDInit(LED3);
  STM_EVAL_LEDInit(LED4);

  /* user1 button (EXTI_Line15) will be used to wakeup ths system from STOP mode */
