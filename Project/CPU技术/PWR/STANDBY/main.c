...
*******************************************************************************
  ...
  FileName		: PWR/STANDBY/main.c 
  Author		: lichy       
  Version 		: 1.0.0     
  Date			: 2011/09/30
  Description	: This example shows how to put the system in Standby mode and 
  				  wake it up from this mode using the external reset, RTC Alarm 
				  or WAKE_UP pin.
  Function List : 
  History		:
  <author>  	: lichy       
