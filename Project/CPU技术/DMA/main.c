...
const uint32_t AAA[BUFFER_SIZE]= {	
...
uint32_t DST1_Buffer[BUFFER_SIZE];
...
int main(void)
{
  ...
  TransferStatus = Buffercmp(AAA, DST_Buffer, BUFFER_SIZE);
...
void DMA_Config(void)
{
  ...
  DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)AAA;
